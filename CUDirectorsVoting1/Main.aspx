...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="Year" DataValueField="Year"></asp:DropDownList>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CUDirConnectionString %>" SelectCommand="SELECT [Year] FROM [_Year]"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CUDirConnectionString %>" 
        SelectCommand="SELECT [id], [Lastname], [Firstname] FROM [Candidates] WHERE YEARRUNNING= 2015"
        InsertCommand="INSERT INTO Candidates ([YEARRUNNING],[Lastname], [Firstname]) VALUES ( 2015, @LASTNAME, @FIRSTNAME)"
